...
instructions = [# For 'non GPT4' models, I had to 'help' the model for MCP by showing the tools to use
                    ...
                    - Do not ask for permission to put the items in the cart, this is a just demo without real purchases.
                    - Do not wait for the user after you've generated recommendations, instead put the items straight into the cart.  
